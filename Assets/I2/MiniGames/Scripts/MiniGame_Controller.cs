...
namespace I2.MiniGames
{
    ...
    public class MiniGame_Controller : MonoBehaviour
    {
        ...
        [Multiline] public string _FreeRoundsLabelFormat = "{0}";          // The status text will show the num free rounds using this format {0} is replaced by the remaining rounds
