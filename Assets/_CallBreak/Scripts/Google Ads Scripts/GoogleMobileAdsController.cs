...
namespace GoogleMobileAds.Samples
{
    ...
    {
        public static Action InitializeGoogleMobileAction;

        private void OnEnable() => InitializeGoogleMobileAction += InitializeGoogleMobile;

        private void OnDisable() => InitializeGoogleMobileAction -= InitializeGoogleMobile;
        ...
        private void InitializeGoogleMobileAds()
        {
            ...
            MobileAds.Initialize((InitializationStatus initstatus) =>
            {
                ...
                RewardedInterstitialAdController.LoadRewardedInterstitialAd();
            });
        }
